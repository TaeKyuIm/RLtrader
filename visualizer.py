...
class Visualizer:
    ...
    def __init__(self, vnet = False):
        self.canvas = None # 캔버스 역할을 하는 Matplotlib의 Figure 클래스 객체
        self.fig = None # 차트를 그리기 위한 Matplotlib의 Axes 클래스 객체
        self.axes = None
        self.title = '' # 그림제목
    ...
    def plot(self, epoch_str = None, num_epoches = None, epsilon = None,
        ...
        with lock:
            ...
            actions = np.array(actions) # 에이전트 행동 배열
            # 가치 신경망의 출력 배열
